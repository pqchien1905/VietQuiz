...
<head>
  ...
  <title>Điểm bài làm đã được công bố</title>
</head>
<body style="margin:0;padding:0;background:#f4f4f5;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,sans-serif;">
  @php
      $label = ($itemType ?? 'quiz') === 'assignment' ? 'bài tập' : 'bài kiểm tra';
  @endphp
        ...
        <table width="600" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:12px;overflow:hidden;box-shadow:0 2px 8px rgba(0,0,0,0.08);">
          <tr>
            <td style="background:linear-gradient(135deg,#6366f1,#8b5cf6);padding:2rem;text-align:center;">
              <h1 style="color:#ffffff;font-size:1.5rem;font-weight:700;margin:0;">Điểm bài làm</h1>
          ...
          <tr>
            <td style="padding:2rem;">
              ...
              <p style="margin:0 0 1.5rem;font-size:1rem;color:#374151;line-height:1.6;">
                Kết quả {{ $label }} <strong>{{ $quizTitle }}</strong> đã được công bố.
              </p>
              ...
              <p style="margin:0 0 1.5rem;font-size:0.875rem;color:#6b7280;">
                Hãy đăng nhập VietQuiz để xem chi tiết kết quả.
              </p>
